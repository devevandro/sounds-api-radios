...
import { IPostCreatePlaylistData } from '../../../../data/youtube-api/post/postCreatePlaylist/IPostCreatePlaylistData';
import { CreatePlaylistEntity } from '../../../../entities/youtube-api/CreatePlaylistEntity';
type ResponseDTO = {
