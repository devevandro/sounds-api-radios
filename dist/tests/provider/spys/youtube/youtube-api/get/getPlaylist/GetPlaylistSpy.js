...
exports.GetPlaylistSpy = void 0;
const faker_1 = require("@faker-js/faker");
class GetPlaylistSpy {
    constructor() {
        this.result = {
    ...
    async getPlaylist({ playlistId, accessToken, }) {
        this.params = { playlistId, accessToken };
        return this.result;
    }
}
exports.GetPlaylistSpy = GetPlaylistSpy;
//# sourceMappingURL=GetPlaylistSpy.js.map